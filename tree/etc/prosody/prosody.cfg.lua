...
modules_enabled = {
	...
	-- Not essential, but recommended
		...
		"blocking"; -- Allow clients to block a list of JIDs (https://code.google.com/p/prosody-modules/source/browse/mod_blocking/mod_blocking.lua)
...
ssl = {
	...
	certificate = "/etc/prosody/certs/server.cert";
}
--TODO: create the key and cert during setup
...
VirtualHost "your_fqdn_here"
--TODO: change this during setup
